// TODO: improve prompt to apply ATS scoring correctly
export const jobMatchPrompt = (job, candidates) => `
    ...
    The array should consist of numeric scores in the same order as the provided candidates.
    Scores can be only between 0-100. 
